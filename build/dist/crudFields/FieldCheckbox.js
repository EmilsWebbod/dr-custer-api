...
var FieldCheckbox = /** @class */ (function (_super) {
    ...
    FieldCheckbox.prototype.render = function () {
        var opts = this.props.opts;
        return (React.createElement("input", __assign({ type: "checkbox", checked: opts.value, disabled: opts.disabled, color: "primary" }, opts.extra), opts.helpField));
    };
